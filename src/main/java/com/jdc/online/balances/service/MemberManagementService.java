...
public class MemberManagementService {
	...
	public void updateStatus(long id, MemberStatusForm form) {
		...
		var member = EntityOperations.safeCall(memberRepo.findById(id), RESOURCE_NAME, KEY_NAME, id);
	...
	public MemberDetails findById(long id) {
		 ...
		 return EntityOperations.safeCall(memberRepo.findById(id).map(MemberDetails::from), RESOURCE_NAME, KEY_NAME, id);
	}
