	...
	<main class="loginForm">
		...
		<sf:form action="${root}/signup" modelAttribute="form" method="post" class="mt-4">
			...
			<app:form-group label="Name" cssClass="mb-3">
				<sf:input path="name" name="username" type="text" placeholder="Enter Name" class="form-control"/>
				<sf:errors path="name" cssClass="text-secondary"></sf:errors>
			</app:form-group>
		
			<app:form-group label="login ID" cssClass="mb-3">
				<sf:input path="username" name="username" type="text" placeholder="Enter login ID" class="form-control"/>
				<sf:errors path="username" cssClass="text-secondary"></sf:errors>
				
			</app:form-group>
			
			<app:form-group label="Password" cssClass="mb-3">
				<sf:input path="password" name="password" type="password" placeholder="Enter Password" class="form-control"/>
